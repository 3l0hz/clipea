...
import { ChevronLeft, ChevronRight, X, ShoppingCart, Box, Info, CheckCircle2, ShieldCheck, Zap } from 'lucide-react';
...
export const ProductModal = ({ product, isOpen, onClose }: ProductModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className={cn(
          "max-w-[100vw] h-[100dvh] md:max-w-7xl md:h-[90vh] p-0 overflow-hidden rounded-none md:rounded-[32px] animate-in zoom-in-95 [&>button]:hidden focus:ring-0 focus:outline-none focus-visible:ring-0 border-none md:border md:border-white/10 shadow-[0_0_100px_rgba(0,0,0,0.8)] bg-[#03050a]"
        )}
      >
        ...
        <div className="flex flex-col md:flex-row h-full relative overflow-y-auto md:overflow-hidden">
          ...
          <div className="w-full md:w-[55%] flex flex-col relative bg-[#050810] shrink-0">
          ...
          <div className="w-full md:w-[45%] flex flex-col bg-[#03050a] md:border-l md:border-white/5">
            <div className="flex-1 overflow-y-auto px-6 py-8 md:px-10 md:py-12 space-y-8">
