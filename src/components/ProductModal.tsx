          ...
          <div className="w-full md:w-[55%] lg:w-[60%] flex flex-col bg-transparent md:border-l md:border-white/5">
            <div className="flex-1 overflow-y-auto px-5 py-5 md:px-16 md:py-16 space-y-6 md:space-y-10">
              ...
              <div className="space-y-1.5 md:space-y-3">
                <h4 className="flex items-center gap-2 text-[8px] md:text-[10px] font-bold uppercase text-cyan-400/40 tracking-[0.4em]">
                  <Info size={10} className="text-cyan-400/50 md:w-3 md:h-3" />
                  Descripción técnica
                </h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-10 py-4 md:py-8 border-y border-white/[0.05]">
                ...
                <div className="space-y-1 md:space-y-2">
                  <h4 className="text-[8px] md:text-[10px] font-bold uppercase text-cyan-400/40 tracking-[0.4em]">Uso Recomendado</h4>
                  <p className="text-white text-xs md:text-base font-bold tracking-tight bg-white/5 w-fit px-2.5 py-1.5 rounded-lg border border-white/5">
              ...
              {product.highlights && product.highlights.length > 0 && (
                <div className="space-y-3 md:space-y-5">
                  <h4 className="text-[8px] md:text-[10px] font-bold uppercase text-cyan-400/40 tracking-[0.4em]">Contenido del paquete</h4>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4">
                    {product.highlights.map((h, i) => (
                      <div key={i} className="flex items-center gap-3 md:gap-4 text-xs md:text-sm text-white/80 font-semibold group">
                        <div className="w-6 h-6 md:w-8 md:h-8 rounded-lg md:rounded-xl bg-cyan-400/5 border border-cyan-400/20 flex items-center justify-center text-cyan-400 shrink-0 group-hover:bg-cyan-400/10 transition-colors">
            ...
            <div className="p-5 md:px-16 md:py-5 bg-white/[0.01] backdrop-blur-2xl border-t border-white/[0.05] flex flex-col sm:flex-row items-center gap-3 md:gap-10">
              <Button 
                ...
                className="w-full sm:w-2/3 h-14 md:h-14 rounded-[24px] text-sm md:text-base font-bold flex items-center justify-center gap-3 md:gap-4 transition-all duration-500 premium-liquid-glass-button"
              >
                <ShoppingCart size={18} strokeWidth={2.5} className="md:w-5 md:h-5 text-white/90" />
                <span className="tracking-[0.1em] md:tracking-[0.15em] uppercase font-black text-white">Agregar al Carrito</span>
              </Button>
              <div className="flex flex-row sm:flex-col items-center sm:items-start justify-center gap-4 sm:gap-1 w-full sm:w-1/3">
                <a 
                  ...
                  className="flex items-center gap-2 text-[10px] md:text-[10px] text-white/40 hover:text-white transition-colors font-bold uppercase tracking-[0.2em]"
                >
